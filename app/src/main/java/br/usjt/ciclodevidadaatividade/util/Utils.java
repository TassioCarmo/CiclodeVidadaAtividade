package br.usjt.ciclodevidadaatividade.util;
...
public class Utils {
    ...
    private br.usjt.ciclodevidadaatividade.util.StatusTracker mStatusTracker = br.usjt.ciclodevidadaatividade.util.StatusTracker.getInstance();
